  ...
  const fetchData = async () => {
    try {
      ...
      categoriesSnapshot.docs.forEach((categoryDoc) => {
        ...
        console.log(`Category ${categoryData.category_name}: shouldShow=${shouldShowCategory}, assigned_to=${categoryData.assigned_to}`);
      ...
      cardsSnapshot.docs.forEach((cardDoc) => {
        ...
        console.log(`Card ${cardData.card_name}: shouldShow=${shouldShowCard}, assigned_to=${cardData.assigned_to}`);
      ...
      const categoriesWithCards = allCategoriesData.filter((category) => {
        const hasCards = cardsData.some((card) => {
          ...
          const caseInsensitiveMatch = card.categoryId.toLowerCase() === category.category_name.toLowerCase();
          return exactMatch || caseInsensitiveMatch;
        });
        
        console.log(`Category "${category.category_name}" has cards:`, hasCards);
        return hasCards;
      });
      ...
      if (categoriesWithCards.length > 0) {
        ...
        const firstCategoryCards = cardsData.filter((card) => {
          ...
          const caseInsensitiveMatch = card.categoryId.toLowerCase() === firstCategoryName.toLowerCase();
